...
public class DCP2 {
	 ...
	 * returns false. To determine if two numbers sum to n, the difference
	 * between n and each number in the list is stored in a set. If the current
	 * number is found in the set (ie the difference was found), then a sum to 
	 * n exits, otherwise it does not.
